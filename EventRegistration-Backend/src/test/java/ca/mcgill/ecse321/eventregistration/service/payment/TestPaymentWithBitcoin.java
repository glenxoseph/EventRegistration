...
public class TestPaymentWithBitcoin {
	...
	public void test_01_testPayWithBitcoin() {
		try {
			...
			Bitcoin ap = service.createBitcoin(TestPaymentWithBitcoinData.TEST01_VALID_ID,
	...
	public void test_04_testMultiplePaysBreakNegative() {
		...
		try {
			for (int i = 0; i < length; i++) {
				...
				Registration r = TestUtils.register(service, person, event);
				pays[i] = service.createBitcoin(ids[i], amounts[i]);
	...
	public void test_05_testUpdatePay() {
		try {
			...
			Registration r = TestUtils.register(service, person, event);
			Bitcoin ap1 = service.createBitcoin(TestPaymentWithBitcoinData.TEST05_INITIAL_ID,
					TestPaymentWithBitcoinData.TEST05_INITIAL_AMOUNT);
			Bitcoin ap2 = service.createBitcoin(TestPaymentWithBitcoinData.TEST05_AFTER_ID,
	...
	public void test_06_testCreateBitcoin() {
		try {
			Bitcoin ap = service.createBitcoin(TestPaymentWithBitcoinData.TEST06_VALID_ID,
	...
	public void test_09_testCreateBitcoinWrongFormat() {
		try {
			service.createBitcoin(TestPaymentWithBitcoinData.TEST09_WRONG_ID,
	...
	public void tst_10_testCreateBitcoinLongFormat() {
		try {
			service.createBitcoin(TestPaymentWithBitcoinData.TEST10_WRONG_ID,
	...
	public void test_11_testCreateBitcoinNull() {
		try {
			service.createBitcoin(TestPaymentWithBitcoinData.TEST11_WRONG_ID,
	...
	public void test_12_testCreateBitcoinEmpty() {
		try {
			service.createBitcoin(TestPaymentWithBitcoinData.TEST12_WRONG_ID,
	...
	public void test_13_testCreateBitcoinSpace() {
		try {
			service.createBitcoin(TestPaymentWithBitcoinData.TEST13_WRONG_ID,
	...
	public void test_14_testCreateBitcoinZero() {
		try {
			Bitcoin ap = service.createBitcoin(TestPaymentWithBitcoinData.TEST14_VALID_ID,
